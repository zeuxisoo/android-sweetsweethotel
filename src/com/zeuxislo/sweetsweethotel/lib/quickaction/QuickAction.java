package com.zeuxislo.sweetsweethotel.lib.quickaction;
...
public class QuickAction extends CustomPopupWindow {
	...
	public QuickAction(View anchor) {
		...
		root		= (ViewGroup) inflater.inflate(R.layout.quickaction_popup, null);
		
		mArrowDown 	= (ImageView) root.findViewById(R.id.quickaction_arrow_down);
		mArrowUp 	= (ImageView) root.findViewById(R.id.quickaction_arrow_up);
	...
	public void show () {
		...
		showArrow(((onTop) ? R.id.quickaction_arrow_down : R.id.quickaction_arrow_up), anchorRect.centerX()-xPos);
